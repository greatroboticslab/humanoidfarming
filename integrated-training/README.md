...
For detailed documentation of Pipeline 1: [Click here](scripts/pipeline1_robot_guidance_model/README.md)
...
For detailed documentation of Pipeline 2: [Click here](scripts/pipeline2_structure_task_dataset/README.md)
