...
source_dir = os.path.abspath("../training_data/blip/")
dest_dir = os.getcwd() + "/blip/"
...
for i in range(smallest):
    ...
    src_path = os.path.join(source_dir, id)
    dst_path = os.path.join(dest_dir, id)
    if i < len(folders):
        print(f"Copying '{src_path}' to '{dst_path}'")
        shutil.copy(src_path + ".txt", dst_path + ".txt")
        shutil.copy(src_path + ".jpg", dst_path + ".jpg")
